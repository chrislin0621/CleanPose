...
class Solver(gorilla.solver.BaseSolver):
    ...
    def solve(self):
        while self.epoch <= self.cfg.max_epoch:
            ...
            dict_info_train, tensor_list = self.train() 
            ...
            if self.epoch % 5 == 0:
                ...
                unnecessary_keys = [key for key in checkpoint.keys() if key.startswith('ULIP_model')]
            ...
            if self.epoch == self.cfg.max_epoch:
                list_path = os.path.join(
                    self.cfg.ckpt_dir, 'tensor_list.pkl')
    ...
    def train(self):
        ...
        for train_data in data_iter:
            ...
            loss, dict_info_step, tensor_list = method(train_data, mode) #
        ...
        return dict_info_epoch, tensor_list
    ...
    def step_camera_real(self, train_data, mode):
        ...
        data = {
            ...
            # 'normal': torch.cat([syn_data['normal'], real_data['normal']], dim=0),
        }
        end_points = self.model(data)
        tensor_list = end_points['tensor_list']
        ...
        return loss_all, dict_info, tensor_list
    ...
    def step_camera(self, train_data, mode):
        ...
        return loss_dict['loss_all'], dict_info, tensor_list
